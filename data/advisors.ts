...
export const advisors: Advisor[] = [
  {
    ...
    name: 'Aakash Sinha',
    company: 'Clazar',
    role: 'Founding Member & Head of Growth',
    expertise: 'GTM Strategy | B2B Marketing | US Market Expansion',
    ...
    bio: 'Aakash Sinha is a growth-focused leader with over 12 years of experience in scaling B2B SaaS companies. As a Founding Member at Clazar, he has been instrumental in developing and executing go-to-market strategies that have driven significant customer acquisition and revenue growth. His expertise in demand generation, sales enablement, and market expansion has helped numerous startups establish strong market positions.',
    experience: [
      'Founding Team at Clazar - Led GTM strategy resulting in 300% YoY growth',
      'Director of Marketing at Highspot - Scaled marketing operations across EMEA and APAC',
      'Senior Product Marketing Manager at Adobe - Launched 3 major product lines generating $50M+ ARR',
      'Marketing Lead at Microsoft - Drove enterprise customer acquisition in cloud services'
    ],
    education: [
      'MBA in Marketing & Strategy, University of Washington',
      'BBA in International Business, University of Mumbai',
      'Certification in Growth Marketing, Reforge'
    ],
    achievements: [
      'Named Top 40 Under 40 in B2B Marketing by Demand Gen Report',
  ...
  },
  {
    ...
    name: 'Akshay Pohekar',
    company: 'Swiggy',
    role: 'Senior Product Manager - Growth & Engagement',
    expertise: 'Product Management | Growth Hacking | User Engagement',
    ...
    bio: 'Akshay Pohekar is a seasoned Product Leader with 8+ years of experience in building and scaling consumer products. Currently at Swiggy, he leads growth initiatives that drive user acquisition, retention, and engagement across multiple markets. His data-driven approach and deep understanding of user psychology have been instrumental in launching features that serve millions of users daily.',
    experience: [
      'Senior PM at Swiggy - Led the growth team to increase MAU by 40% through retention strategies',
      'Product Manager at Ola - Spearheaded Ola Money integration, reaching 5M+ transactions/month',
      'Associate PM at Flipkart - Drove key initiatives in the payments and checkout experience',
      'Product Analyst at Zomato - Optimized search and discovery features, improving conversion by 25%',
