            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="md:w-1/3 flex flex-col items-center">
                ...
                <a 
                  ...
                  className="flex items-center justify-center w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors mb-3"
                >
                  <Linkedin className="w-5 h-5 mr-2" />
                  Connect on LinkedIn
                </a>
                <button
                  onClick={() => alert('This feature is only available for Circle Members')}
                  className="w-full py-2 px-4 bg-yellow-500 hover:bg-yellow-600 text-black font-medium rounded-lg transition-colors flex items-center justify-center"
                >
                  <span>Book a Meeting</span>
                  <span className="ml-2 text-xs bg-black/20 px-2 py-0.5 rounded-full">Circle Only</span>
                </button>
              </div>
